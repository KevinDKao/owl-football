...
OUTPUT_DIR = os.path.join(BASE_DIR, "random_forest", "output_no_rating")
...
for year in test_years:
    ...
    # Create a plot focusing on just the drafted players
...
with open(os.path.join(OUTPUT_DIR, "summary_report.txt"), "w") as f:
    f.write(
        f"Random Forest Model for NFL Draft Position Prediction (No Rating Features)\n"
    )
